...
Window {
    ...
    function builtinComponent(compId) {
    ...
    RowLayout {
        ...
        RowLayout {
            ...
            Repeater {
                ...
                Loader {
                    Layout.preferredWidth: pluginManager.preferredWidth(modelData)
                    Layout.fillWidth: pluginManager.fillWidth(modelData)
                    Layout.fillHeight: true
                    sourceComponent: pluginManager.isBuiltin(modelData) ? builtinComponent(modelData) : null
                    source: pluginManager.isBuiltin(modelData) ? "" : pluginManager.componentUrl(modelData)
